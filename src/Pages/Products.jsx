...
<Product head={`He-Man`} content={`Dive into the cutting-edge world of robotics with our mind-blowing Human Robotic Head! 🤖 Explore the fusion of humanity and technology as we unravel the secrets behind this AI marvel. Join the conversation and witness the future today! `} img={"src/images/head.png"} />
...
efficiency to automation.`}   img={"src/images/Pickplace.png"} />
